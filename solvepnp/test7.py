...
for box in bounding_boxes:
    # Extract the 2D coordinates of the bounding box
    xmin = box['xmin']
    ymin = box['ymin']
    xmax = box['xmax']
    ymax = box['ymax']

    # Create an array of the 2D points of the bounding box
...
#for box in bounding_boxes_with_points:
#    # Extract the projected points
#    projected_points = box['projected_points']
#
...
#    cv2.line(image, (int(top_center_x), int(top_center_y)), (int(bottom_center_x), int(bottom_center_y)), (0, 0, 255), 2)  # Red line
...
# Assuming you have your bounding_boxes_with_points and image ready
...
# Now, image_with_axes contains the axes drawn on the image using the projected points
